...
const Modal = ({ isVisible = false, onClose, setTitle, changeItems, id }) => {
    ...
    return !isVisible ? null : (
        <div className="modal" onClick={onClose}>
            <div className="modal-dialog" onClick={e => e.stopPropagation()}>
                ...
                <div className="newTitle">Новое название задачи</div>
                <Input func={(e) => setTitle(e)} />
                <Button func={() => {changeItems(id); onClose()}}><svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="System / Save">
                ...
                <Button func={onClose}><svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
