    ...
    return (
        <div className="todo_item">
            ...
            <div className="buttons">
                <Button class='btn' func={()=>props.deleteItems(props.todo.id)}><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
                ...
                <ChangeTodo setTitle={props.setTitle} changeItems={props.changeItems} id={props.todo.id}></ChangeTodo>
                <Button class='knop' func={()=>props.completeItem(props.todo.id)}>
